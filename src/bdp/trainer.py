...
class BaseTrainingProcedure(metaclass=ABCMeta):
    """Basic class for training and logging the models_ implemented in this framework.

    This class is used for training models_ implemented in this framework. The class is
    handeling the model trainin, logging and booking. In order this class to be used
    the models_ must be child class from the ``kiwissenbase.models_.AModel``. This means
